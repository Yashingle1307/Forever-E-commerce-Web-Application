...
const Add = ({token}) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      console.log("Error submitting product:", error.response?.data || error.message);
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <select onChange={(e) => setSubCategory(e.target.value)} value={subCategory} className='w-full px-3 py-2' >
            ...
            <option value="Bottomwwear">Bottomwear</option>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type='Number' placeholder='ex.100rs' />
        </div>
